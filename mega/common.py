...
class Common:
    def __init__(self):
       ...
       #     self.owner = int(self.app_config.get("owner", "owner_id"))
       #     self.database_url = self.app_config.get("database", "db_link")
       #     self.force_sub = int(self.app_config.get("force_sub", "fsub_channelid"))
       #     self.time_gap = int(self.app_config.get("time_gap", "time_gap_in_seconds"))
